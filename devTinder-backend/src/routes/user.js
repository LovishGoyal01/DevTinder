...
const USER_SAFE_DATA =
  "firstName lastName photoURL age gender about skills isProfileCompleted";
...
userRouter.get("/feed", userAuth, async (req, res) => {
  try {
    ...
    connectionRequest.forEach((req) => {
      hideUserFromFeed.add(String(req.fromUserId));
      hideUserFromFeed.add(String(req.toUserId));
    });
